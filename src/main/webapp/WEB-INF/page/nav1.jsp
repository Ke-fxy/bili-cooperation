...
<body>
<nav class="navbar navbar-default" id="nav1" role="navigation" style="height: 180px; background-image: url(${APP_PATH}/static/img/0.png);">
    <div class="container-fluid">
        <div class="navbar-header col-sm-5 col-md-5 ">
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="#" class="btn btn-default" data-toggle="modal" data-target="#myModal" style="background-color: ">直播</a>
                </li>
                <!-- 模态框 -->
