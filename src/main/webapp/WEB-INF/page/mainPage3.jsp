    ...
    <div class="row">
        <div class="col-xs-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="350">
                ...
                <li><a href="#section-3">科技区</a></li>
                <li><a href="${APP_PATH}/toMainPage4">生活区</a></li>
                <li><a href="${APP_PATH}/toMainPage5">二次元</a></li>
            </ul>
        </div>
        <div class="col-xs-9">
            <h2 id="section-3">科技区</h2>
            <div  id="zone3" class="row">

            </div>
            <div class="row">
                <div class="col-lg-6" id="pia3">

                </div>
                <div class="col-lg-6" id="pna3">
    ...
    function build_page_nav(result,pna){
        ...
        if(result.extend.pageInfo.hasPreviousPage == false){
            ...
            prePageLi.click(function (){
                to_Page(result.extend.pageInfo.pageNum - 1,"sc","#zone3","#pia3","#pna3");
            });
        }
        ...
        if (result.extend.pageInfo.hasNextPage == false){
            ...
            lastPageLi.click(function (){
                to_Page(result.extend.pageInfo.pages,"sc","#zone3","#pia3","#pna3");
            });
        }
        ...
        $.each(pages,function (index,item){
            ...
            numLi.click(function (){
                to_Page(item,"sc","#zone3","#pia3","#pna3");
            });
            ul.append(numLi);
        });
